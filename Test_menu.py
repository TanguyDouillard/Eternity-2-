...
def menu():
    global choix_grille, taille_piece, scene, running
    ...
    while running:
        ...
        screen.blit(titre, (largeur_screen // 2 - titre.get_width() // 2, 100))
        ...
        if bouton_jouer.collidepoint(pygame.mouse.get_pos()):
            couleur_jouer = (255, 50, 50) if choix_grille is None else (0, 100, 200)
        else:
            couleur_jouer = (255, 0, 0) if choix_grille is None else (0, 150, 255)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if bouton_jouer.collidepoint(event.pos) and choix_grille is not None:
                    taille_piece = 480//choix_grille
                    scene = 2
