...
import random
import time
import matplotlib.pyplot as plt #TEST POUR IA
import networkx as nx #TEST POUR IA
...
def draw_ecran():
    global choix_grille, taille_piece, couleur_fond_ecran ,couleur_fond_grille, couleur_grille, couleur_grille_lignes, couleur_titre, couleur_titre_regles, couleur_texte_regles, couleur_fond_regles, couleur_contour_regles, bouton_retour, bouton_quitter, bouton_ia, bouton_son, couleur_bouton_2, couleur_hover_bouton_2, couleur_texte_bouton_2
